...
if (__name__ == "__main__"):
    ...
    WB_out = Signal(intbv(0, 0, 2**0))
    MemToReg_out = Signal(intbv(0, 0, 2**0))
    MemWrite_out = Signal(intbv(0, 0, 2**0))
    MemRead_out = Signal(intbv(0, 0, 2**0))
    lwFlush_out = Signal(intbv(0, 0, 2**0))
    brFlush_out = Signal(intbv(0, 0, 2**0))
    ...
    WB_in = Signal(intbv(0, 0, 2**0))
    MemToReg_in = Signal(intbv(0, 0, 2**0))
    MemWrite_in = Signal(intbv(0, 0, 2**0))
    MemRead_in = Signal(intbv(0, 0, 2**0))
    lwFlush_in = Signal(intbv(0, 0, 2**0))
    brFlush_in = Signal(intbv(0, 0, 2**0))
